...
def get_tagline(product_attributes, company):
    ...
    prompt += [
        "####",
        "SEO Guidance:",
        "Generate an SEO keyword list tailored to the product.",
        "Keywords must be specific to the bag’s unique attributes and avoid generic terms.",
        "Keyword Hierarchy (incorporate these into the product description where natural):",
        "- **Primary Keywords** - Describing product type (e.g., Denim leather bag, Ruched shoulder bag, Drawstring shoulder bag)",
        "- **Secondary Keywords** - Describing materials, details, or characteristics (e.g., Denim with ruching, Smooth leather accents, Detachable crossbody strap, Ruched design)",
        "- **Tertiary Keywords** - Describing functionality or use (e.g., Interior zip pocket, Everyday shoulder bag, Versatile ruched bag)",
    ]
...
def main():
    ...
    save_path = "Coach_Results_iteration_3.xlsx"
